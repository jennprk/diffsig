...
vignette: |
  %\VignetteIndexEntry{diffsig - association of risk factors and 
...
```{r, fig.width=3, fig.height=8, fig.align='center'}
...
```{r fig.height=3, fig.width=3, fig.align='center', eval=F}
diffsig_plot(fit, 
             pars=1:numpars, 
             ci_level = 80,
             signature_labels = c("SBS2","SBS3","SBS13"),
...
```{r fig.width=3, fig.height=8, fig.align='center', eval=F}
diffsig_plot(fit, 
             pars=1:numpars, 
             ci_level = 80,
             signature_labels = c("SBS2","SBS3","SBS13"),
